...
export class Hyperspeed {
    constructor(container, effectOptions) {
        ...
        // Dispose previous instance content in container if any
...
class App {
    constructor(container, options = {}) {
        console.log("Hyperspeed App Constructor");
    ...
    loadAssets() {
        ...
        return new Promise(resolve => {
            ...
            // These might fail if not available globally. 
            // In postprocessing > 6.x, they are usually:
